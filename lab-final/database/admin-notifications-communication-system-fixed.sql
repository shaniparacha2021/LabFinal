...
DROP FUNCTION IF EXISTS send_direct_notification(VARCHAR, TEXT, direct_notification_type, TEXT, notification_priority, VARCHAR, TEXT[], VARCHAR, VARCHAR, TIMESTAMP WITH TIME ZONE, BOOLEAN, BOOLEAN, JSONB);
