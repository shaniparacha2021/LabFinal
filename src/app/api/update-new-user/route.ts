...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('❌ Update new user error:', error)
    return NextResponse.json({
      success: false,
...
export async function GET(request: NextRequest) {
  return NextResponse.json({
    message: 'Update New User Endpoint',
    description: 'Updates the newly created Supabase auth user to Super Admin',
    usage: 'POST /api/update-new-user',
    user_details: {
    ...
    features: [
      'Updates user with correct UID from Supabase auth',
